...
datos_entrenamiento = 'C:/Users/TOREROS-II/Documents/ANDRES/UNI/PAE/prototipo_signos/fotos/entrenamiento'
datos_validacion = 'C:/Users/TOREROS-II/Documents/ANDRES/UNI/PAE/prototipo_signos/fotos/validacion'
...
clases = 5  #5 vocales (5 dedos y 0 dedos)
...
cnn.add(Convolution2D(filtrosconv2, tam_filtro3, padding = 'same', activation='relu')) #Agregamos nueva capa
cnn.add(MaxPooling2D(pool_size=tam_pool))
...
cnn.add(Dense(640,activation='relu'))  #Asignamos 256 neuronas
