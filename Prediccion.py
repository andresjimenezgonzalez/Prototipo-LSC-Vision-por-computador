...
modelo = 'C:/Users/TOREROS-II/Documents/ANDRES/UNI/PAE/prototipo_signos/Modelo.h5'
peso =  'C:/Users/TOREROS-II/Documents/ANDRES/UNI/PAE/prototipo_signos/pesos.h5'
cnn = load_model(modelo)  #Cargamos el modelo
cnn.load_weights(peso)  #Cargamos los pesos

direccion = 'C:/Users/TOREROS-II/Documents/ANDRES/UNI/PAE/prototipo_signos/fotos/validacion'
    ...
    if resultado.multi_hand_landmarks: #Si hay algo en los resultados entramos al if
        for mano in resultado.multi_hand_landmarks:  #Buscamos la mano dentro de la lista de manos que nos da el descriptor
            ...
            if len(posiciones) != 0:
                ...
                pto_i5 = posiciones[9]
                if pto_i5[1] != None and pto_i5[2] != None:
                    ...
                    if respuesta == 0:
                        ...
                        cv2.putText(frame, '{}'.format('LETRA DESCONOCIDA'), (x1, y1 - 5), 1, 1.3, (255, 255, 0), 1, cv2.LINE_AA)
